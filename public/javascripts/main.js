...
function submit_form() {
	if (username.value.length && names.value.length && password.value.length >= 6 && confirmpassword.value.length >= 6 && password.value === confirmpassword.value) {
		myform.submit();
		// return true;
		...
		// console.log('success')
		js.style.display = 'flex'
		jspara.innerText = 'Password and Confirm must be same'
